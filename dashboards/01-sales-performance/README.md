...
2. Install dependencies:
   ...
   ```
3. Add CSV file at `data/raw/sales_data.csv`
4. Run app:
   ```bash
...
2. Recreate KPI cards and visuals listed above
3. Export screenshots to `assets/`

## 11. Tools & Tech
- Python, Pandas
- Streamlit, Plotly
- Tableau / Power BI (optional BI version)
